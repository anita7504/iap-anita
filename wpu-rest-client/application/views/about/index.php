            ...
            <div class="col-md mb-4">
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <a href="<?= base_url(); ?>../json/video 3/latihan1.php" class="card-link see-detail"data-bs-toggle="modal" data-bs-target="#exampleModal" data-id="`+ data.imdbID +`" >See Project</a>
                </div>
              </div>
            </div>
            ...
            <div class="col-md mb-4">
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <a href="<?= base_url(); ?>../vedio 4/latihan2.html" class="card-link see-detail"data-bs-toggle="modal" data-bs-target="#exampleModal" data-id="`+ data.imdbID +`" >See Project</a>
                </div>
              </div>
            </div>
            ...
            <div class="col-md mb-4">
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <a href="<?= base_url(); ?>../vedio 5/index.html" class="card-link see-detail"data-bs-toggle="modal" data-bs-target="#exampleModal" data-id="`+ data.imdbID +`" >See Project</a>
                </div>
              </div>
            </div>   
          </div>
          ...
          <div class="row">
            <div class="col-md mb-4">
              <div class="card">
                ...
                <div class="card-body">
                  <h5>Anita-PORTFOLIO</h5>
                  <p class="card-text">Latihan API menggunakan Public API Youtube dan Instagram menggunakan cURL berbasis website.</p>
                  <a href="<?= base_url(); ?>../vedio 6/index.php" class="card-link see-detail"data-bs-toggle="modal" data-bs-target="#exampleModal" data-id="`+ data.imdbID +`" >See Project</a>
                </div>
              </div>
            </div> 
            <div class="col-md mb-4">
              <div class="card">
                ...
                <div class="card-body">
                  <h5>Anita-REST-SERVER</h5>
                  <p class="card-text">Membuat Rest Server menggunakan framework CodeIgniter3.
                  </p>
                  <a href="<?= base_url(); ?>../vedio7/" class="card-link see-detail"data-bs-toggle="modal" data-bs-target="#exampleModal" data-id="`+ data.imdbID +`" >See Project</a>
                </div>
              </div>
            </div>
